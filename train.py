...
import numpy as np
import argparse
from data import icdar_dataset
...
parser = argparse.ArgumentParser(
    description='Textbox Detector Training With Pytorch')
...
def train():
    ...
    #加载icdar数据
    dataset = icdar_dataset.ICDARData(root = DATAROOT ,img_path = IMG_PATH, txt_path = TXT_PATH)
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(tb_net.state_dict(), 'weights/tb_ICDAR_' +
                       repr(iteration) + '.pth')
